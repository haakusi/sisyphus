...
// TodoItem for hooks (alias for Todo)
...
export type CompletionReason =
  | 'stability'      // No output changes for N polls
  | 'idle_event'     // Session became idle
  | 'timeout'        // Stall timeout reached
