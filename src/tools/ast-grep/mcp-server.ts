 ...
 */
export async function astSearch(params: ASTSearchParams): Promise<ASTToolResult> {
  try {
 ...
 */
export async function astReplace(params: ASTReplaceParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astRefactor(params: ASTRefactorParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astFindFunctions(params: ASTFindParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astFindClasses(params: ASTFindParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astFindImports(params: ASTFindImportsParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astValidatePattern(params: ASTValidateParams): Promise<ASTToolResult> {
  try {
    const engine = getASTGrepEngine();
 ...
 */
export async function astListRules(): Promise<ASTToolResult> {
  const engine = getASTGrepEngine();
  const rules = engine.getRefactorRules();
...
function formatSearchResult(result: ASTSearchResult, type: string = 'match'): string {
  const lines: string[] = [];
...
function formatReplaceResult(result: ASTReplaceResult, isDryRun: boolean): string {
  const lines: string[] = [];
...
function formatRefactorResult(rule: RefactorRule, result: ASTReplaceResult, isDryRun: boolean): string {
  const lines: string[] = [];
...
function formatRulesList(rules: RefactorRule[]): string {
  const lines: string[] = ['Available Refactoring Rules:', ''];

  // Group by language
  const byLang = new Map<string, RefactorRule[]>();
...
function groupByFile(matches: ASTMatch[]): Array<{ file: string; matches: ASTMatch[] }> {
