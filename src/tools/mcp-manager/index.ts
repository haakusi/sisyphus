...
// Preset definitions
const AVAILABLE_SERVERS: Record<string, PresetServer> = {
  figma: {
...
}): Promise<{ success: boolean; formatted?: string; error?: string; data?: unknown }> {
  try {
...
// Tool: List Presets
export async function mcpListPresets(): Promise<{
  success: boolean;
  formatted?: string;
  data?: unknown;
}> {
