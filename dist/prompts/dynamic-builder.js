...
function buildIntentGateSection(skills) {
...
function buildCodebaseAssessmentSection() {
    return {
...
function buildDelegationSection(agents) {
...
function buildRulesSection(additionalRules) {
    const rules = [
