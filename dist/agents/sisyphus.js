...
import { createPromptBuilder } from '../prompts/dynamic-builder.js';
// ============================================
// Intent Detection
// ============================================
...
// Skill Matching
// ============================================
export function matchSkill(message, availableSkills) {
...
// Codebase Assessment
// ============================================
export async function assessCodebase(projectRoot) {
...
// Todo List Creation
// ============================================
export function createTodoList(task) {
...
// Delegation
// ============================================
export function determineDelegation(task, intent, availableAgents) {
...
// ============================================
export function planParallelExecution(tasks, availableAgents) {
...
export function createSisyphusAgent(options = {}) {
    ...
    return {
        ...
        async processMessage(message) {
            ...
            const delegation = determineDelegation({
                ...
                createdAt: new Date(),
                updatedAt: new Date(),
            }, intent, options.availableAgents || []);
            if (delegation) {
                return {
                    phase: 'execution',
                    action: 'delegate',
...
//# sourceMappingURL=sisyphus.js.map